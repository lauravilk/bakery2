...
try{
    ...
    $yhteys=mysqli_connect("db", "root", "password", "tilaukset");
}
catch(Exception $e){
...
$tulos=mysqli_query($yhteys, "select * from tilaustiedot");

while ($rivi=mysqli_fetch_object($tulos)){
    print "id=$rivi->id nimi=$rivi->nimi osoite=$rivi->osoite
    puhelin=$rivi->puhelin sposti=$rivi->sposti tiedot=$rivi->tiedot";
